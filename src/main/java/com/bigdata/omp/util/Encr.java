...
import java.util.List;
 ...
 public class Encr
 {
     ...
     public  static final String PWD_ENCRYPTED_PREFIX = "Encrypted ";
     ...
     public static final String encryptPasswordIfNotUsingVariables(String password)
     {
         ...
         if (varList.isEmpty())
         {
             encrPassword = PWD_ENCRYPTED_PREFIX +Encr.encryptPassword(password);
         }
         else
         {
     ...
     {
         if (password!=null && password.startsWith(PWD_ENCRYPTED_PREFIX))
         {
             return Encr.decryptPassword( password.substring(PWD_ENCRYPTED_PREFIX.length()) );
         }
         return password;
     }

     public static final String decryptPasswordOptionallyObf(String password)
     {
     ...
     //add by shaolizhen 20100825 OBF解密
     public static final String encryptPasswordOptionallyObf(String password)
     {
         if(password == null)
         {
             return "";
     ...
     /*public static void main(String[] args) {
         System.out.println(Encr.decryptPasswordOptionallyEncrypted("Encrypted 2be98afc86aa7f2e4bb18bd63c9c2bdde"));//解密
         System.out.println(Encr.encryptPasswordIfNotUsingVariables("passw0rd"));//加密
     }*/
 }
